            ...
            <div class="flex flex-col-reverse lg:flex-row gap-10 lg:gap-16 items-start lg:items-center">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400 mt-0.5">
                                Plateforme de finances communautaires & mutuel — Haïti
                            </p>
                        </div>
                    </div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-5 leading-relaxed">
                        Plateforme centralisée de gestion des opérations de finances communautaires et mutuel, des clients, des comptes et des transactions pour le réseau KAYPA en Haïti.
                    </p>
