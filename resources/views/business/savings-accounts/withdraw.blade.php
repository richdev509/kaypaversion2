        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    Retrait KEB — {{ $account->business->name }}
                </h2>
    ...
    <div class="py-8">
        <div class="max-w-lg mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                ...
                <div class="mb-5 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg flex justify-between text-sm">
                    <span class="text-gray-600 dark:text-gray-400">Solde disponible</span>
                    <span class="font-semibold text-red-700 dark:text-red-300">{{ number_format($account->balance, 2) }} HTG</span>
                </div>
                ...
                <form method="POST" action="{{ route('business.keb.withdraw', $account) }}" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="number" name="amount" value="{{ old('amount') }}"
                            min="1" max="{{ $account->balance }}" step="0.01" required
                    ...
                    <div class="flex justify-end gap-3 pt-2 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <button type="submit"
                            ...
                            class="px-4 py-2 text-sm text-white bg-red-600 hover:bg-red-700 rounded-lg transition disabled:opacity-40 disabled:cursor-not-allowed">
