    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                Dépôt — <span class="font-mono">{{ $account->account_number }}</span>
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-lg mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                ...
                <div class="mb-5 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                    ...
                    <p class="text-2xl font-bold text-indigo-600 dark:text-indigo-400 mt-1">
                        {{ number_format($account->balance, 2) }} HTG <span class="text-sm font-normal text-gray-500">solde actuel</span>
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('business.kcb.deposit', $account) }}" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="number" name="amount" value="{{ old('amount') }}"
                            ...
                            class="w-full rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500 text-xl font-semibold">
                    ...
                    <div>
                        ...
                        <select name="method" required class="w-full rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div class="flex justify-end gap-3 pt-2">
                        ...
                        <button type="submit"
                            class="px-4 py-2 text-sm text-white bg-green-600 hover:bg-green-700 rounded-lg transition font-semibold">
                            Confirmer le dépôt
                        </button>
                    </div>
                </form>
