    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                Retrait — {{ $currentAccount->account_number }}
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 p-4 bg-orange-50 dark:bg-orange-900 border border-orange-200 dark:border-orange-700 rounded-lg">
                <p class="text-sm text-orange-800 dark:text-orange-200">
                    ...
                    <strong>Solde disponible :</strong> {{ number_format($currentAccount->balance, 2) }} HTG
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('current-accounts.withdraw', $currentAccount) }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                Maximum : {{ number_format($currentAccount->balance, 2) }} HTG
                            </p>
                            @error('amount')
                        ...
                        <div class="flex justify-end gap-3">
                            ...
                            <button type="submit" class="px-6 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg text-sm font-medium">
