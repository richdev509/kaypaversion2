            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                            Affichage des 2 dernières transactions du compte (lecture seule).
                        </p>
                            ...
                            <div class="border dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-700/50">
                                <div class="flex justify-between items-start mb-2">
                                    <div>
                                        ...
                                        <span class="ml-2 font-bold text-lg">{{ number_format($trans->amount, 2) }} HTG</span>
                                    </div>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">{{ $trans->created_at->diffForHumans() }}</span>
                                </div>
                                <div class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                                    <div class="flex justify-between">
                                        <span>Référence:</span>
                                        <span class="font-mono">{{ $trans->reference ?? $trans->id_transaction }}</span>
                                    </div>
