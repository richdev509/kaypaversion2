...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('current_account_transactions', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('current_account_id');        // bigint unsigned — correspond à current_accounts.id
            $table->integer('client_id');                            // int — correspond à clients.id
            $table->enum('type', ['DEPOT', 'RETRAIT', 'FRAIS_OUVERTURE', 'FRAIS_SERVICE']);
            ...
            $table->foreign('current_account_id')->references('id')->on('current_accounts')->onDelete('restrict');
